...
import CreateService from "./pages/garage-service/CreateService.jsx";
import CreatePaint from "./pages/paint/CreatePaint.jsx";
import ListPaint from "./pages/paint/ListPaint.jsx";
import ListService from "./pages/garage-service/ListService.jsx";
...
const QUERY_STALE_TIME_SEC = 1;

const queryClient = new QueryClient({
    defaultOptions: {
        queries: {
            staleTime: QUERY_STALE_TIME_SEC * 1000,
        },
    },
});
